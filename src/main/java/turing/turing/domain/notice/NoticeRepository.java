...
public interface NoticeRepository extends JpaRepository<Notice, Long> {
    ...
    List<Notice> findAllByReceiverIdAndReceiverRoleAndReadStatus(Long receiverId, Role receiverRole, boolean readStatus);
    List<Notice> findAllByReceiverIdAndReceiverRoleAndCreatedAtAfter(Long receiverId, Role receiverRole, LocalDateTime createdAt);
